		...
		head: {
			...
			meta: [
				...
				{ name: "format-detection", content: "telephone=no" },
				{
					name: "description",
					content:
						"HI，我是 Billy，有數年的前端工作經歷，因為先前工作類別接觸到較多案量，所以熟悉與 PM、設計、前後端等團隊人員合作，協同討論需求並建置出網站（如：企業形象、活動頁面），而對於工作節奏與狀況變動，也具有一定的掌握跟彈性。",
				},
			...
			link: [
				...
				{
					rel: "stylesheet",
					href: "https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@100;400;700&family=Rubik:wght@500;700&display=swap",
				},
			],
		},
	},
